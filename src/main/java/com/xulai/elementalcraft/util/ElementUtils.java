 ...
 * - Get strict consistent attack element (used for elemental reaction triggers)
 */
public class ElementUtils {
    ...
    public static ElementType getConsistentAttackElement(LivingEntity attacker) {
        ...
        // As long as total enhancement points > 0, it meets the consistency condition
