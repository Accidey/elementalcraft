...
public final class BiomeAttributeBias {
    ...
    /**
     * 判断给定群系是否属于森林或丛林类群系。
     * 使用标签系统进行判定，以支持模组添加的新群系。
     * <p>
     * Determines if the given biome belongs to the forest or jungle category.
     * Uses the tag system for determination to support new biomes added by mods.
     *
     * @param biomeHolder 群系持有者 / Biome holder
     * @return 是否符合条件 / Whether it meets the condition
     */
