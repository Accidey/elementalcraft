 ...
 * This enchantment can only be applied to armor (head, chest, legs, feet) and has a maximum level of 5.
 */
public class ElementEnhancementEnchantment extends Enchantment {
    ...
    public boolean checkCompatibility(Enchantment other) {
        if (other instanceof ElementEnhancementEnchantment that) {
            // 相同元素允许兼容（铁砧可升级） / Same element allows compatibility (anvil upgradable)
