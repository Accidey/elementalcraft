 ...
 * Includes a floor mechanism: When restraint occurs, a minimum percentage of damage is dealt even with high resistance.
 * Also integrates Wetness System modifications.
 */
...
public class CombatEvents {
    ...
    public static void onLivingDamage(LivingDamageEvent event) {
        ...
        // [攻击部分] = 原始伤害 * 全局伤害倍率 * 潮湿修正 * 克制倍率
        // [Attack Part] = Raw Dmg * Global Dmg Multiplier * Wetness Mod * Restraint Multiplier
        ...
        DebugCommand.sendCombatLog(
            ...
            wetnessMultiplier,   // 6. 潮湿倍率 (float)
