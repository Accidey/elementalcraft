    ...
    public static void onLivingDamage(LivingDamageEvent event) {
        ...
        if (wetnessLevel > 0) {
            ...
            if (attackElement == ElementType.FIRE) {
                ...
                // 自然属性：增伤 + 汲取逻辑
                // Nature Element: Damage Bonus + Siphon Logic
                
                // 1. 计算增伤
                // 1. Calculate Damage Bonus
                float bonusPerLevel = (float) ElementalReactionConfig.natureWetnessBonus;
                float totalBonus = Math.min(wetnessLevel * bonusPerLevel, maxCap); 
        ...
        // ==================== 6. 应用最终伤害公式 (核心修改) ====================
        // ==================== 6. Apply Final Formula (Core Modification) ====================
