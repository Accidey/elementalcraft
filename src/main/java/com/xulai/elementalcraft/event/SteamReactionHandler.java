...
public class SteamReactionHandler {
    ...
    /**
     * 自我干燥逻辑。
     * 当自身处于潮湿状态且使用赤焰攻击时触发，消耗潮湿层数并对周围造成蒸汽爆发。
     * <p>
     * Self-Drying Logic.
     * Triggered when the attacker is wet and uses a fire attack. Consumes wetness levels and causes a steam burst around.
     */
    private static void applySelfDrying(LivingEntity attacker, LivingHurtEvent event, int currentWetness) {
        ...
        int layersToRemove = Math.max(1, fireEnhancement / threshold);
