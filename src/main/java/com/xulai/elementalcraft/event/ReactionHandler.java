...
public class ReactionHandler {
    ...
    public static final String NBT_WILDFIRE_COOLDOWN = "ec_wildfire_cd";
    ...
    public static SporeApplyResult stackSporeEffect(LivingEntity target, int layersToAdd, LivingEntity applier) {
        ...
        if (newStacks > 0) {
            target.addEffect(new MobEffectInstance(ModMobEffects.SPORES.get(), durationTicks, newStacks - 1, false, true, true));
    ...
    public static boolean checkCooldown(LivingEntity entity, String key) {
        CompoundTag data = entity.getPersistentData();
