...
public final class ElementalConfig {
    ...
    static {
        ...
        MOB_ATTRIBUTE_CHANCE_HOSTILE = BUILDER
                .comment("敌对生物（如僵尸、骷髅、苦力怕）成为属性生物的概率。",
                        "当敌对生物生成时，该概率决定它是否获得元素属性。",
                        "数值越高，世界中属性生物越多。",
                        "",
                        "Chance for hostile mobs (e.g., Zombies, Skeletons, Creepers) to become elemental.",
        ...
        MOB_ATTRIBUTE_CHANCE_NEUTRAL = BUILDER
                .comment("中立生物（如猪灵、末影人、狼）成为属性生物的概率。",
                        ...
                        "数值越高，更多中立生物获得元素能力。",
                        "",
                        "Chance for neutral mobs (e.g., Piglins, Endermen, Wolves) to become elemental.",
        ...
        ATTACK_ATTRIBUTE_CHANCE = BUILDER
                .comment("属性生物获得与其群系偏好元素一致的攻击属性的概率。",
                        ...
                        "同时为攻击与护甲强化掷取强化点数。",
                        "",
                        "Chance for an elemental mob to gain an attack element matching its biome-biased element.",
                        "If triggered, the mob's weapon will be enchanted with the attack element.",
                        "Strength points are rolled for both attack and armor enhancement.",
                        "",
        ...
        COUNTER_RESIST_CHANCE = BUILDER
                .comment("属性生物获得针对自身克制属性的抗性的概率。",
                        ...
                        "",
                        "Chance for an elemental mob to gain resistance against the element that counters its attack.",
        ...
        CHANCE_0_20 = BUILDER
                .comment("在最大值的 0~20% 区间内取值的概率。",
                        "数值越高，弱小生物越多。",
                        "",
                        "Probability of rolling a value in the 0-20% range of max.",
        ...
        CHANCE_20_50 = BUILDER
                .comment("在最大值的 20~50% 区间内取值的概率。",
                        "这是普通档位。",
                        "",
                        "Probability of rolling a value in the 20-50% range of max.",
        ...
        CHANCE_50_80 = BUILDER
                .comment("在最大值的 50~80% 区间内取值的概率。",
                        "这些生物明显更强。",
                        "",
                        "Probability of rolling a value in the 50-80% range of max.",
        ...
        MOB_FLEE_ENABLED = BUILDER
                .comment("开启后，属性生物会被光环影响的生物吓跑。",
                        "控制灼烧/静电/霜冻光环触发的逃跑行为。",
                        "",
                        "When enabled, elemental mobs will flee from aura-affected entities.",
        ...
        BUILDER.comment("Mob Potion Throw (Wetness)", "属性生物投掷水瓶（潮湿）")
                .push("mob_potion_throw");

        MOB_POTION_THROW_ENABLED = BUILDER
                .comment("开启后，属性生物有概率在主手攻击前向目标投掷喷溅水瓶施加潮湿。",
                        "",
                        "When enabled, elemental mobs may throw a splash water bottle at their target before attacking,",
                        "applying WETNESS.",
                        "",
                        "Default: true / 默认：true")
        ...
        MOB_BOTTLE_EQUIP_CHANCE = BUILDER
                .comment("属性生物装备副手水瓶的概率（每只生物只判定一次）。",
                        ...
                        "",
                        "Chance for an eligible attribute mob to equip an offhand water bottle (rolled once per mob).",
                        "If passed, the mob remains a thrower for its lifetime.",
                        "",
        ...
        MOB_BOTTLE_THROW_COOLDOWN = BUILDER
                ...
                .defineInRange("mob_bottle_throw_cooldown", 200, 10, 1200);

        BUILDER.pop();

        BUILDER.comment("Vanilla Tweaks", "原版调整")
                .push("vanilla_tweaks");

        POTION_STACK_64 = BUILDER
                .comment("允许原版药水瓶（药水/喷溅药水/滞留药水）堆叠到 64 个。",
                        "关闭则保持原版 1 个的堆叠上限。若与其他模组冲突可关闭。",
                        "",
                        "Allow vanilla potion bottles (Potion/Splash Potion/Lingering Potion) to stack up to 64.",
                        "If disabled, vanilla stack limit of 1 is kept. Disable if another mod causes conflicts.",
                        "",
                        "Default: true / 默认：true")
        ...
        STRENGTH_PER_LEVEL = BUILDER
                .comment("每级属性强化附魔提供多少强化点数。",
                        "这也影响强制属性生物的强化点数如何转化为附魔等级。",
                        "公式：附魔等级 = 总点数 / strength_per_level",
                        "",
                        "How many strength points each level of the Elemental Strength enchantment provides.",
        ...
        RESIST_PER_LEVEL = BUILDER
                .comment("每级属性抗性附魔提供多少抗性点数。",
                        ...
                        "",
                        "How many resistance points each level of the Elemental Resistance enchantment provides.",
        ...
        MAX_STAT_CAP = BUILDER
                .comment("单件护甲上单个属性（强化或抗性）的最大点数上限。",
                        ...
                        "",
                        "Maximum points for a SINGLE attribute on a SINGLE armor piece.",
        ...
        STRENGTH_PER_HALF_DAMAGE = BUILDER
                .comment("控制每点强化值增加多少元素伤害。",
                        "公式：元素伤害 += (0.5 / 该值) × 强化点数",
                        "",
                        "Controls how much elemental damage each strength point adds.",
        ...
        RESIST_PER_HALF_REDUCTION = BUILDER
                .comment("控制每点抗性值减免多少元素伤害。",
                        "公式：伤害减免 += (0.5 / 该值) × 抗性点数",
                        "",
                        "Controls how much elemental damage each resistance point reduces.",
        ...
        ELEMENTAL_DAMAGE_MULTIPLIER = BUILDER
                .comment("全局元素伤害倍率，作用于所有元素伤害。",
                        "最终伤害 = 计算出的元素伤害 × 此倍率",
                        "",
                        "Global multiplier applied to ALL elemental damage dealt.",
        ...
        ELEMENTAL_RESISTANCE_MULTIPLIER = BUILDER
                .comment("全局元素抗性减免倍率，作用于所有元素抗性减免。",
                        "最终减免 = 计算出的抗性减免 × 此倍率",
                        "",
                        "Global multiplier applied to ALL elemental resistance reduction.",
        ...
        RESTRAINT_MULTIPLIER = BUILDER
                .comment("当攻击方元素克制目标元素时的伤害倍率。",
                        "示例：赤焰 vs 自然（赤焰克制自然）→ 伤害 × 此值",
                        "",
                        "Damage multiplier when the attacker's element restrains the target's element.",
        ...
        WEAK_MULTIPLIER = BUILDER
                .comment("当攻击方元素被目标元素克制时的伤害倍率。",
                        ...
                        "",
                        "Damage multiplier when the attacker's element is WEAK against the target's element.",
        ...
        RESTRAINT_MIN_DAMAGE_PERCENT = BUILDER
                .comment("即使抗性完全抵消伤害，仍然保留的最低元素伤害百分比。",
                        ...
                        "",
                        "Minimum elemental damage percentage that ALWAYS gets through, even if resistance fully negates it.",
        ...
        ELEMENT_RESTRAINTS = BUILDER
                .comment("定义属性克制关系。",
                        ...
                        "",
                        "Define which element restrains which.",
        ...
        FORCED_ENTITIES = BUILDER
                .comment("为指定实体类型自定义强制元素属性。",
                        "列表中的实体将跳过正常随机生成，直接使用这里定义的属性。",
                        "",
                        "Custom forced elemental attributes for specific entity types.",
        ...
        NETHER_DIMENSION_FORCED_FIRE = BUILDER
                .comment("开启后，下界维度中所有生成的生物自动获得：",
                        ...
                        "",
                        "When enabled, ALL mobs spawned in the Nether dimension automatically gain:",
        ...
        END_DIMENSION_FORCED_THUNDER = BUILDER
                .comment("开启后，末地维度中所有生成的生物自动获得：",
                        ...
                        "关闭后回退到正常随机生成或 forced_entities 配置。",
                        "",
                        "When enabled, ALL mobs spawned in The End dimension automatically gain:",
        ...
        END_THUNDER_POINTS = BUILDER
                .comment("末地强制雷霆属性使用的点数，同时应用于强化和抗性。",
                        "",
                        "The point value used for End forced Thunder strength AND resistance.",
                        "This value is applied to both strength and resistance equally.",
                        "",
        ...
        BLACKLISTED_ENTITIES = BUILDER
                .comment("列表中的实体永远不会获得元素属性。",
                         "全局生效：随机生成、下界/末地强制、以及 forced_entities 配置均被阻止。",
                         "",
                        "Entities listed here will NEVER receive elemental attributes.",
        ...
        ENCHANTED_BOOK_DROP_CHANCE = BUILDER
                .comment("属性生物死亡时掉落附魔书的基础概率。",
                         "",
                        "Base chance for an elemental mob to drop an enchanted book on death.",
                         "",
        ...
        ENCHANTED_BOOK_LOOTING_BONUS = BUILDER
                .comment("每级抢夺附魔增加的掉落概率。",
                        "",
                        "Additional drop chance per level of Looting enchantment.",
                        "",
        ...
        ENCHANTED_BOOK_LEVEL_SPREAD = BUILDER
                .comment("控制附魔书掉落等级在生物自然等级附近的集中程度。",
                        ...
                        "数值越高 = 越集中在自然等级附近。",
                        "",
                        "示例：100 点数、strength_per_level=5 时 → 自然等级 ≈ 5，最高等级 = 5：",
                        "  spread=0.0: Lv.1~5 各 20%",
                        "  spread=1.0: Lv.5≈40%、Lv.4≈20%、Lv.3≈13%、Lv.2≈10%、Lv.1≈8%",
                        "  spread=3.0: Lv.5≈60%、Lv.4≈21%、Lv.3≈12%、Lv.2≈5%、Lv.1≈2%",
                        "",
                        "Controls how concentrated the enchanted book level is around the mob's natural level.",
        ...
        COLD_FROST_BIAS = BUILDER
                .comment("寒冷生物群系（雪原、冰刺之地、冻洋等）中冰霜属性的权重。",
                        "",
                        "Weight for Frost element in cold biomes (Snowy Plains, Ice Spikes, Frozen Ocean, etc.).",
                        "",
                        "Default: 60.0 / 默认：60.0")
        ...
        FOREST_NATURE_BIAS = BUILDER
                .comment("森林类生物群系（森林、黑森林、花林、丛林等）中自然属性的权重。",
                        "",
                        "Weight for Nature element in forest biomes (Forest, Dark Forest, Flower Forest, Jungle, etc.).",
                        "",
                        "Default: 60.0 / 默认：60.0")
        ...
        THUNDERSTORM_THUNDER_BIAS = BUILDER
                .comment("雷雨天气时雷霆属性的权重（全局生效，覆盖群系偏好）。",
                        ...
                        "群系的赤焰/冰霜/自然权重仍正常竞争。",
                        "",
                        "Weight for Thunder element during thunderstorm weather (global, overrides biome bias).",
        ...
        CUSTOM_BIOME_ATTRIBUTE_BIAS = BUILDER
                .comment("为特定生物群系覆盖或补充默认的属性权重。",
                        "此处的条目优先于默认的炎热/寒冷/森林偏好（对匹配的群系生效）。",
                        "",
                        "Override or supplement the default biome attribute weights for specific biomes.",
    ...
    public static boolean matchesBlacklist(List<? extends String> blacklist, String entityId) {
        ...
        for (String entry : blacklist) {
            if (entry.indexOf(':') >= 0 ? entry.equals(entityId) : entityId.startsWith(entry + ':'))
                return true;
        }
        return false;
    }
