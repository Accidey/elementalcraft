...
public final class ElementalThunderFrostReactionsConfig {
    ...
    static {
        ...
        PARALYSIS_SPREAD_THRESHOLD_PERCENTAGE = BUILDER
                .comment("Percentage of max paralysis stacks required to trigger static shock spread . 0.5 = 50%.",
                         "触发静电传染所需的麻痹层数百分比。0.5 = 50%。",
                         "Default: 0.5")
        ...
        PARALYSIS_SPREAD_STATIC_PERCENTAGE = BUILDER
                .comment("Percentage of paralysis stacks to convert to static shock stacks . 0.5 = 50%.",
                         "麻痹层数转换为静电层数的百分比。0.5 = 50%。",
                         "Default: 0.5")
