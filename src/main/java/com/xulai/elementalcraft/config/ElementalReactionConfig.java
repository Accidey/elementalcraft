...
public class ElementalReactionConfig {
    ...
    static {
        ...
        STEAM_SCALDING_DAMAGE = BUILDER
                .comment("Damage dealt by High Heat steam per second (Bypasses Armor).",
                        "高温蒸汽每秒造成的烫伤伤害（无视物理护甲）。")
    ...
    public static void refreshCache() {
        ...
        // Logger for Debugging / 调试日志
        ElementalCraft.LOGGER.info("[ElementalCraft] Reaction Config Refreshed / 元素反应配置已刷新:");
        ElementalCraft.LOGGER.info(" > Steam Trigger Thresholds / 蒸汽触发阈值: Fire/赤焰={}, Frost/冰霜={}", steamTriggerThresholdFire, steamTriggerThresholdFrost);
        ElementalCraft.LOGGER.info(" > Steam Damage Logic / 蒸汽伤害逻辑: FloorRatio/保底比例={}, FireProtCap/火保上限={}, GeneralProtCap/普保上限={}", steamDamageFloorRatio, steamMaxFireProtCap, steamMaxGeneralProtCap);
        ElementalCraft.LOGGER.info(" > Enchantment Exclusivity / 附魔互斥: {}", enchantFireAspectExclusive);
    }
}