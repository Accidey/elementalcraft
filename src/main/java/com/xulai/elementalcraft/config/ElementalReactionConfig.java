...
public class ElementalReactionConfig {
    ...
    public static final ForgeConfigSpec.DoubleValue STEAM_RADIUS_PER_LEVEL; // [新增]
    public static final ForgeConfigSpec.IntValue STEAM_CLOUD_DURATION;
    public static final ForgeConfigSpec.IntValue STEAM_DURATION_PER_LEVEL; // [新增]
    ...
    public static final ForgeConfigSpec.DoubleValue STEAM_DAMAGE_SCALE_PER_LEVEL; // [新增]
    ...
    public static void refreshCache() {
        ...
        ElementalCraft.LOGGER.info(" > Steam Scaling / 蒸汽缩放: Radius/半径+={}, Duration/时间+={}t, Damage/伤害+={}x", steamRadiusPerLevel, steamDurationPerLevel, steamDamageScalePerLevel);
        ElementalCraft.LOGGER.info(" > Condensation Interval / 冷凝间隔: {} ticks", steamCondensationInterval);
