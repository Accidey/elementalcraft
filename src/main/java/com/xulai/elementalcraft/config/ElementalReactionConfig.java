...
public class ElementalReactionConfig {
    ...
    public static final ForgeConfigSpec.DoubleValue WETNESS_MAX_REDUCTION; // 独立的潮湿减伤上限
    ...
    public static final ForgeConfigSpec.IntValue WETNESS_TICK_INTERVAL; // 潮湿逻辑更新间隔
    public static final ForgeConfigSpec.DoubleValue WETNESS_HEAT_SEARCH_RADIUS; // 热源检测半径
    ...
    public static final ForgeConfigSpec.DoubleValue SCORCHED_SHOCK_DAMAGE_RATIO; // 热休克爆发伤害比例
