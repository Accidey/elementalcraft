...
public class DebugCommand {
    ...
    private static String buildEnchDetail(String primaryEnchKey, int primaryLevel, int generalLevel) {
        if (primaryLevel > 0 && generalLevel > 0) {
            return Component.translatable(primaryEnchKey).getString() + " " + primaryLevel
                    + " + " + Component.translatable("enchantment.minecraft.protection").getString() + " " + generalLevel;
        } else if (primaryLevel > 0) {
            return Component.translatable(primaryEnchKey).getString() + " " + primaryLevel;
        } else {
            return Component.translatable("enchantment.minecraft.protection").getString() + " " + generalLevel;
        }
    }
    ...
    public static class FireCounterLogContext {
    ...
    public static class FrostCounterLogContext {
        public LivingEntity target;
    ...
    public static void sendFireFreezeMeltLog(LivingEntity target, LivingEntity attacker, int frozenStacks, int newWetness, int firePower, int requiredPoints) {
        ...
        MutableComponent content = Component.translatable("debug.elementalcraft.reaction.fire_freeze_melt.message",
                ...
                Component.literal(String.valueOf(newWetness)).withStyle(ChatFormatting.AQUA),
