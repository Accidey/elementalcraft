 ...
 * 它负责在服务器启动时的 RegisterCommandsEvent 事件中，手动调用那些没有自行处理注册逻辑的命令类。
 * <p>
 * English Description:
 ...
 * It is responsible for manually calling command classes that do not handle their own registration logic during the RegisterCommandsEvent at server startup.
 */
...
public class ModCommands {
    ...
    public static void registerCommands(RegisterCommandsEvent event) {
        ...
        // 注册潮湿效果黑名单命令
        // Register WetnessBlacklistCommand
