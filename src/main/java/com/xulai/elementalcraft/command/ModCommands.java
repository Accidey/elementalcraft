...
public class ModCommands {
     ...
     * 其他命令（如 BlacklistCommand、ForcedItemCommand、ForcedEntityCommand 等）已通过各自类中的 @SubscribeEvent 自动注册，无需在此重复。
     *
     ...
     * Other commands (e.g., BlacklistCommand, ForcedItemCommand, ForcedEntityCommand) are automatically registered via @SubscribeEvent in their own classes and do not need to be repeated here.
     *
