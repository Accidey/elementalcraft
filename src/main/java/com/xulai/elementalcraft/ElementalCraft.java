 ...
 * 负责模组的初始化工作，包括：
 * 1. 注册配置文件 (Common, ForcedItem, Reaction)。
 ...
 * 1. Registering configuration files (Common, ForcedItem, Reaction).
...
public class ElementalCraft {
    ...
    public ElementalCraft() {
        ...
        // Note: Classes annotated with @Mod.EventBusSubscriber (like WetnessHandler, ConfigAutoSync, SteamReactionHandler) do not need manual registration here.
