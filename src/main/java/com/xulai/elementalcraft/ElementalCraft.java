...
public class ElementalCraft {
    ...
    public ElementalCraft() {
        ...
        // 注意：带有 @Mod.EventBusSubscriber 注解的类（如 WetnessHandler, ConfigAutoSync）不需要在此处手动注册。
        // Note: Classes with @Mod.EventBusSubscriber (like WetnessHandler, ConfigAutoSync) do not need manual registration here.
